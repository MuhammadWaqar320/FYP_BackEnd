...
from .models import Product,Category,SubCategory,SpecialOffer,Shipper,Customer,SubmittedReview

# Register your models here.
@admin.register(Product,Category,SubCategory,Shipper,SpecialOffer,Customer,SubmittedReview)
